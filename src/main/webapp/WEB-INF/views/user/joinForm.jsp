...
<body>
  ...
  <div class="modal-content">
      <div class="modal-header">
          ...
          <h1 style="margin:0 auto;">Join</h1>
      </div>
      <div class="modal-body">
          <form class="form col-md-12 center-block" method="POST" action="/user/join">
            ...
            <div class="form-group">
              <button class="btn btn-primary btn-lg btn-block">Join Now!</button>
              <span class="pull-right"><a href="/user/loginForm">Login</a></span>
            </div>
          </form>
      </div>
